/*
  ...
  - The values [ICON] on the enum `CategoryImageType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "CategoryImageType_new" AS ENUM ('IMAGE', 'BANNER');
